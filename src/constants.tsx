...
export const INSURANCE_GROUPS: string[] = ['Property', 'Vehicle', 'Health', 'Life', 'Business', 'UK'];
...
export const INITIAL_INSURANCE_POLICIES: InsuranceInfo[] = [
    { 
        ...
        coverageSummary: 'Building cover up to £500k, contents up to £75k.',
        lastReviewed: '2023-11-28',
        deductible: 250,
        contactNumber: '0800 051 2345',
        notes: 'Includes accidental damage cover.'
    },
    { 
        id: 'ins-2', 
        ...
        groups: ['Vehicle', 'UK'], 
        policyType: 'Comprehensive Car', 
        status: 'Active', 
        policyholder: 'John Doe', 
        premiumAmount: 80, 
        paymentFrequency: 'Monthly',
        policyNumber: 'DL-98765432',
        coverageAmount: 30000,
        startDate: '2024-03-15',
        endDate: '2025-03-14',
        lastReviewed: '2024-03-10',
        deductible: 500,
        contactNumber: '0345 246 8701',
        notes: 'Business use included. No claims bonus protected.'
    },
    { 
        id: 'ins-3', 
        ...
        policyNumber: 'AXA-LL-555444',
        coverageAmount: 250000,
        startDate: '2024-06-01',
        endDate: '2025-05-31',
        lastReviewed: '2024-05-20',
        deductible: 300,
        contactNumber: '0330 024 1158',
        notes: 'Includes loss of rent and property owners liability.'
    },
    { 
        id: 'ins-4', 
        ...
        premiumAmount: 120,
        paymentFrequency: 'Monthly',
        policyNumber: 'BUPA-PH-333222',
        coverageAmount: 1000000,
        startDate: '2024-01-20',
        endDate: '2025-01-19',
        lastReviewed: '2024-01-15',
        deductible: 100,
        contactNumber: '0808 256 4975',
        notes: 'Comprehensive cover with dental and optical.'
    },
    { 
        id: 'ins-5', 
        ...
        status: 'Expired',
        policyholder: 'My Company Ltd',
        premiumAmount: 800,
        paymentFrequency: 'Annually',
        policyNumber: 'HIS-PI-111000',
        coverageAmount: 2000000,
        startDate: '2023-08-15',
        endDate: '2024-08-14',
        lastReviewed: '2023-08-01',
        deductible: 1000,
        contactNumber: '0800 280 0354',
        notes: 'Covers professional negligence claims.'
    },
];
...
export const VEHICLE_GROUPS: string[] = ['Personal', 'Work', 'UK', 'Australia'];
