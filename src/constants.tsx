...
import type { AppInfo, ProjectInfo, PropertyInfo, InsuranceInfo, ContractInfo, InvoiceInfo, VehicleInfo, RegistrationFeeInfo, ShoppingItem } from './types';
...
export const FEE_GROUPS: string[] = ['Medical registration', 'Membership', 'Subscription'];

export const INITIAL_REGISTRATION_FEES: RegistrationFeeInfo[] = [];
