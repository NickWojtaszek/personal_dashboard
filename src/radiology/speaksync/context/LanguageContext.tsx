...
const pl = {
  ...
  "report": {
    ...
    "entries": "wpisy",
    "noEntriesForPeriod": "Brak badań w wybranym okresie.",
    "submitButton": "Złóż raport do weryfikacji",
    "submitting": "Wysyłanie...",
    "submissionSuccess": "Raport został pomyślnie złożony do weryfikacji!",
    "submissionError": "Błąd podczas wysyłania raportu. Spróbuj ponownie.",
    "errorPersonalInfo": "Najpierw uzupełnij dane osobowe.",
    "errorNoEntries": "Brak wpisów do wysłania.",
    "partialMonthWarningTitle": "Częściowe rozliczenie miesiąca",
    "partialMonthWarningDesc": "Składasz raport przed końcem miesiąca. Możesz ponownie złożyć pełny raport w następnym miesiącu.",
    "partialFlag": "Częściowy miesiąc",
    "total": "Razem",
    "status": "Status przetwarzania",
    "pending": "Oczekuje na weryfikację",
    "verified": "Zweryfikowany",
    "rejected": "Odrzucony",
    "duplicateWarningTitle": "Zduplikowane numery badań",
    "duplicateWarning": "UWAGA: Następujące numery badań już istnieją w systemie",
    "duplicateProceed": "Może to wskazywać na podwójne zgłoszenie. Czy chcesz kontynuować?",
    "duplicateFlag": "Zduplikowane numery badań",
    "duplicateStudyWarning": "Ten numer badania został już przesłany przez innego użytkownika",
    "duplicateSubmissionBlocked": "Nie można wysłać: Wykryto zduplikowane numery badań. Przejrzyj wpisy z ostrzeżeniami.",
    "conflictingStudies": "Sprzeczne numery badań",
    "conflictDetail": "Badanie #{{numerBadania}} zostało wcześniej przesłane przez {{email}}",
    "verificationCommentsPlaceholder": "Dodaj komentarze lub powody odrzucenia...",
    "approveButton": "Zatwierdź i zweryfikuj",
    "rejectButton": "Odrzuć",
    "reviewButton": "Przeglądaj i weryfikuj",
    "verifierDashboard": "Panel weryfikatora",
    "verifierDashboardTitle": "Panel weryfikacji",
    "noPendingReports": "Brak raportów oczekujących na weryfikację.",
    "approvedReports": "Zatwierdzone raporty",
    "rejectedReports": "Odrzucone raporty",
    "verifiedBy": "Zweryfikowano przez",
    "verifiedDate": "Data",
    "comments": "Komentarze",
    "rejectionCommentRequired": "Podaj powód odrzucenia.",
    "history": "Historia raportów",
    "newReport": "Nowy raport",
    "noSubmittedReports": "Nie złożyłeś jeszcze żadnych raportów."
  }
};
...
const en = {
  ...
  "report": {
    ...
    "entries": "entries",
    "noEntriesForPeriod": "No studies found for this period.",
    "submitButton": "Submit Report for Verification",
    "submitting": "Submitting...",
    "submissionSuccess": "Report submitted successfully for verification!",
    "submissionError": "Error submitting report. Please try again.",
    "errorPersonalInfo": "Please complete your personal information first.",
    "errorNoEntries": "No entries to submit.",
    "partialMonthWarningTitle": "Partial Month Submission",
    "partialMonthWarningDesc": "You are submitting a report before the end of the month. You can resubmit a complete month's report next month.",
    "partialFlag": "Partial Month",
    "total": "Total",
    "status": "Processing Status",
    "pending": "Pending Verification",
    "verified": "Verified",
    "rejected": "Rejected",
    "duplicateWarningTitle": "Duplicate Study Numbers",
    "duplicateWarning": "WARNING: The following study numbers already exist in the system",
    "duplicateProceed": "This may indicate duplicate submission or potential fraud. Do you want to proceed?",
    "duplicateFlag": "Duplicate Study Numbers",
    "duplicateStudyWarning": "This study number has already been submitted by another user",
    "duplicateSubmissionBlocked": "Cannot submit: Duplicate study numbers detected. Please review entries with warnings.",
    "conflictingStudies": "Conflicting Study Numbers",
    "conflictDetail": "Study #{{numerBadania}} was previously submitted by {{email}}",
    "verificationCommentsPlaceholder": "Add comments or reasons for rejection...",
    "approveButton": "Approve & Verify",
    "rejectButton": "Reject",
    "reviewButton": "Review & Verify",
    "verifierDashboard": "Verifier Dashboard",
    "verifierDashboardTitle": "Verification Dashboard",
    "noPendingReports": "No pending reports for verification.",
    "approvedReports": "Approved Reports",
    "rejectedReports": "Rejected Reports",
    "verifiedBy": "Verified by",
    "verifiedDate": "Date",
    "comments": "Comments",
    "rejectionCommentRequired": "Please provide a reason for rejection.",
    "history": "Report History",
    "newReport": "New Report",
    "noSubmittedReports": "You haven't submitted any reports yet."
  }
};
...
const de = {
  ...
  "report": {
    "title": "Monatsbericht",
    "selectPeriod": "Abrechnungszeitraum wählen",
    "entries": "Einträge",
    "noEntriesForPeriod": "Keine Studien für diesen Zeitraum gefunden.",
    "submitButton": "Bericht zur Überprüfung einreichen",
    "submitting": "Wird gesendet...",
    "submissionSuccess": "Bericht erfolgreich zur Überprüfung eingereicht!",
    "submissionError": "Fehler beim Einreichen des Berichts. Bitte versuchen Sie es erneut.",
    "errorPersonalInfo": "Bitte füllen Sie zuerst Ihre persönlichen Daten aus.",
    "errorNoEntries": "Keine Einträge zum Einreichen.",
    "partialMonthWarningTitle": "Teilweise Monatsabrechnung",
    "partialMonthWarningDesc": "Sie reichen einen Bericht vor Monatsende ein. Sie können nächsten Monat einen vollständigen Bericht einreichen.",
    "partialFlag": "Teilmonat",
    "total": "Gesamt",
    "status": "Verarbeitungsstatus",
    "pending": "Überprüfung ausstehend",
    "verified": "Überprüft",
    "rejected": "Abgelehnt",
    "duplicateWarningTitle": "Doppelte Studiennummern",
    "duplicateWarning": "WARNUNG: Die folgenden Studiennummern existieren bereits im System",
    "duplicateProceed": "Dies könnte auf eine doppelte Einreichung hinweisen. Möchten Sie fortfahren?",
    "duplicateFlag": "Doppelte Studiennummern",
    "duplicateStudyWarning": "Diese Studiennummer wurde bereits von einem anderen Benutzer eingereicht",
    "duplicateSubmissionBlocked": "Einreichung nicht möglich: Doppelte Studiennummern erkannt. Bitte überprüfen Sie die Einträge mit Warnungen.",
    "conflictingStudies": "Widersprüchliche Studiennummern",
    "conflictDetail": "Studie #{{numerBadania}} wurde zuvor von {{email}} eingereicht",
    "verificationCommentsPlaceholder": "Kommentare oder Ablehnungsgründe hinzufügen...",
    "approveButton": "Genehmigen & Überprüfen",
    "rejectButton": "Ablehnen",
    "reviewButton": "Überprüfen & Verifizieren",
    "verifierDashboard": "Überprüfer-Dashboard",
    "verifierDashboardTitle": "Überprüfungs-Dashboard",
    "noPendingReports": "Keine ausstehenden Berichte zur Überprüfung.",
    "approvedReports": "Genehmigte Berichte",
    "rejectedReports": "Abgelehnte Berichte",
    "verifiedBy": "Überprüft von",
    "verifiedDate": "Datum",
    "comments": "Kommentare",
    "rejectionCommentRequired": "Bitte geben Sie einen Ablehnungsgrund an.",
    "history": "Berichtsverlauf",
    "newReport": "Neuer Bericht",
    "noSubmittedReports": "Sie haben noch keine Berichte eingereicht."
  }
};
