...
const TEMPLATES = [
  ...
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "UPPER ABDOMINAL ORGANS",
        concise: "Normal liver, spleen, and pancreas. No focal lesions. Normal gallbladder and adrenal glands.",
        semiconcise: "Normal liver size and attenuation with no focal lesions. Normal spleen (11cm). Normal pancreatic body and tail without dilatation of the pancreatic duct. Normal gallbladder with no calculi or wall thickening. Normal adrenal glands bilaterally.",
        verbose: "The liver is normal in size and attenuation with no focal hepatic lesions or evidence of steatosis. The spleen measures 11cm in craniocaudal dimension and is homogeneous with no focal abnormalities. The pancreatic body and tail demonstrate normal attenuation without focal lesions or dilatation of the pancreatic duct. The gallbladder is normal in caliber with no calculi, wall thickening, or pericholecystic fluid. The adrenal glands are normal in size and morphology bilaterally.",
      },
      {
        label: "GENITOURINARY AND GASTROINTESTINAL TRACT",
        concise: "Normal kidneys with no masses or hydronephrosis. Normal urinary bladder. Normal bowel caliber. Age-appropriate pelvic organs.",
        semiconcise: "Normal kidneys bilaterally with no masses, calculi, or hydronephrosis. Symmetric cortical thickness. Normal ureters. Normal urinary bladder with no wall thickening. Normal bowel caliber with no obstruction or wall thickening. Age-appropriate pelvic organs.",
        verbose: "The kidneys are normal in size and position bilaterally with smooth contours and no masses, calculi, or hydronephrosis. The renal cortical thickness is symmetric and preserved. The ureters are not dilated. The urinary bladder is adequately distended with no wall thickening, intraluminal filling defects, or perivesical abnormalities. The bowel demonstrates normal caliber throughout with no evidence of obstruction, wall thickening, or inflammatory changes. The pelvic organs are age-appropriate in appearance.",
      },
      {
        label: "VESSELS, LYMPH NODES AND BONES",
        concise: "Normal abdominal aorta and IVC. No lymphadenopathy. No free fluid. Normal osseous structures.",
        semiconcise: "Normal abdominal aorta and IVC caliber. No pathological lymphadenopathy in the retroperitoneum, mesentery, or pelvis. No free intraperitoneal fluid or pneumoperitoneum. Normal visualized osseous structures with no suspicious lesions.",
        verbose: "The abdominal aorta and inferior vena cava are normal in caliber with no aneurysmal dilatation or intraluminal thrombus. No pathologically enlarged lymph nodes are identified in the retroperitoneum, mesentery, or pelvis by standard size criteria. There is no free intraperitoneal fluid, pneumoperitoneum, or mesenteric fat stranding. The visualized osseous structures including the lumbar spine and pelvis demonstrate no suspicious lytic or sclerotic lesions.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal non-contrast examination of abdomen and pelvis.",
        semiconcise: "Normal non-contrast CT examination of the abdomen and pelvis. No acute intra-abdominal or pelvic pathology.",
        verbose: "Normal non-contrast CT examination of the abdomen and pelvis. No evidence of acute intra-abdominal or pelvic pathology. All solid organs, bowel, and osseous structures are within normal limits.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "Consider contrast-enhanced examination if enhanced assessment needed. Clinical correlation advised.",
        semiconcise: "Consider contrast-enhanced examination if further characterisation of soft tissue structures is required. Clinical correlation advised for ongoing symptoms.",
        verbose: "Consider contrast-enhanced CT examination if further characterisation of solid organs or soft tissue structures is clinically warranted. Clinical correlation is advised for ongoing symptoms. No urgent radiological follow-up is required based on these normal findings.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        label: "URINARY TRACT",
        concise: "Normal kidneys with no calculi or hydronephrosis. Normal ureters throughout course. Normal urinary bladder with no calculi.",
        semiconcise: "Normal kidneys bilaterally with preserved cortical thickness and no calculi, hydronephrosis, or perinephric abnormality. Ureters are not dilated and no calculi are identified throughout their course. Normal urinary bladder with adequate distension and no intraluminal calculi or wall thickening.",
        verbose: "The kidneys are normal in size and position bilaterally with preserved cortical thickness and smooth contours. No renal calculi, hydronephrosis, or perinephric stranding is identified. The ureters are not dilated bilaterally and no radio-opaque calculi are identified throughout their course from the pelviureteric junctions to the vesicoureteric junctions. The urinary bladder is adequately distended with no intraluminal calculi, wall thickening, or perivesical abnormalities.",
      },
      {
        label: "ADDITIONAL STRUCTURES",
        concise: "Normal abdominal organs and bowel caliber. Normal osseous structures.",
        semiconcise: "The visualized abdominal organs including the liver, spleen, and pancreas appear normal within the limitations of a non-contrast study. Normal bowel caliber with no obstruction. Normal osseous structures with no suspicious lesions.",
        verbose: "The visualized abdominal organs including the liver, spleen, and pancreas appear normal within the limitations of a non-contrast, low-dose study. The bowel demonstrates normal caliber throughout with no evidence of obstruction or significant wall thickening. No free intraperitoneal fluid is identified. The visualized osseous structures including the lumbar spine and pelvis demonstrate no suspicious lytic or sclerotic lesions. The appendix is not significantly dilated where visualized.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal KUB examination. No evidence of urinary tract calculi.",
        semiconcise: "Normal low-dose CT KUB examination. No urinary tract calculi or hydronephrosis. No alternative cause for symptoms identified.",
        verbose: "Normal low-dose CT KUB examination. No evidence of urinary tract calculi or hydronephrosis at any level. No alternative intra-abdominal cause for the patient's symptoms is identified.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No radiological follow-up required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No radiological follow-up required based on these normal findings. Clinical correlation advised if symptoms persist. Consider ultrasound if renal pathology remains a concern.",
        verbose: "No radiological follow-up is required based on these normal findings. Clinical correlation is advised if symptoms of renal colic persist. Consider renal tract ultrasound for further assessment if clinical suspicion remains high, or contrast-enhanced CT if an alternative diagnosis is being considered.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "KIDNEYS AND EXCRETION",
        concise: "Normal kidney size and enhancement. Symmetric contrast excretion. Normal pelvicalyceal systems. No renal calculi.",
        semiconcise: "Normal kidney size bilaterally (R: 11cm, L: 10.5cm) with homogeneous enhancement on nephrographic phase. Symmetric and prompt contrast excretion. Normal non-dilated pelvicalyceal systems bilaterally. No renal calculi or focal renal lesions on pre-contrast images.",
        verbose: "The kidneys are normal in size bilaterally (right: 11cm, left: 10.5cm) with smooth contours and homogeneous cortical enhancement on the nephrographic phase. Symmetric and prompt contrast excretion is demonstrated on the delayed excretory phase images. The pelvicalyceal systems are normal in configuration bilaterally with no dilatation, filling defects, or calyceal blunting. No renal calculi are identified on pre-contrast images. No focal renal masses or cystic lesions are identified on any phase.",
      },
      {
        label: "URETERS AND BLADDER",
        concise: "Normal ureteral caliber with complete opacification. No filling defects or strictures. Normal bladder with smooth contours.",
        semiconcise: "Normal ureteral caliber bilaterally with complete opacification on excretory phase. No filling defects, strictures, or periureteral abnormalities. Normal bladder with smooth mucosal contours, no intraluminal masses or wall thickening.",
        verbose: "The ureters are of normal caliber bilaterally with complete opacification demonstrated on the excretory phase images from the pelviureteric junctions to the vesicoureteric junctions. No filling defects, strictures, kinking, or periureteral soft tissue abnormalities are identified. The urinary bladder is adequately distended with smooth mucosal contours. No intraluminal filling defects, masses, or bladder wall thickening is identified. No perivesical abnormality is seen.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal urogram. No evidence of urinary tract pathology.",
        semiconcise: "Normal CT urogram with symmetric renal enhancement and excretion. No urinary tract pathology or urothelial abnormality.",
        verbose: "Normal CT urogram examination. Symmetric renal enhancement and prompt contrast excretion bilaterally. No evidence of urinary tract calculi, urothelial lesions, or obstructive uropathy. The kidneys, ureters, and bladder are within normal limits.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No radiological follow-up required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No radiological follow-up required based on these normal findings. Clinical correlation advised if haematuria or urinary symptoms persist.",
        verbose: "No radiological follow-up is required based on these normal findings. Clinical correlation is advised if haematuria or urinary tract symptoms persist. Consider cystoscopy for further evaluation of the lower urinary tract if clinically indicated.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "PELVIC BONES AND JOINTS",
        concise: "Normal pelvic ring alignment. No fractures. Intact acetabula and hip joints. Normal sacrum and coccyx.",
        semiconcise: "Normal pelvic ring alignment with intact pubic symphysis and sacroiliac joints. No fractures or dislocations. Intact acetabula bilaterally with congruent hip joints. Normal sacrum and coccyx without fractures. Normal femoral heads.",
        verbose: "The pelvic ring alignment is normal with intact pubic symphysis and sacroiliac joints demonstrating no widening or malalignment. No fractures or dislocations are identified involving the iliac wings, pubic rami, ischial tuberosities, or obturator rings. The acetabula are intact bilaterally with congruent hip joints and no evidence of fracture, dislocation, or significant degenerative change. The sacrum and coccyx are normal without fractures or malalignment. The femoral heads and necks show normal morphology.",
      },
      {
        label: "PELVIC ORGANS AND SOFT TISSUES",
        concise: "Normal urinary bladder. Age-appropriate pelvic viscera. No soft tissue abnormalities.",
        semiconcise: "Normal urinary bladder with no wall thickening. Age-appropriate pelvic viscera. No pelvic free fluid or soft tissue abnormalities. Normal pelvic musculature with no haematoma.",
        verbose: "The urinary bladder is adequately distended with no wall thickening, intraluminal filling defects, or perivesical abnormalities. The pelvic viscera are age-appropriate in appearance with no masses or lymphadenopathy. No pelvic free fluid is identified. The pelvic musculature including the iliopsoas, obturator internus, and gluteal muscles demonstrate no evidence of haematoma, tear, or abnormal enhancement. The subcutaneous soft tissues are unremarkable.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal pelvis examination. No evidence of traumatic injury.",
        semiconcise: "Normal CT pelvis examination. No fractures, dislocations, or significant soft tissue injury.",
        verbose: "Normal CT pelvis examination. No evidence of acute fractures, dislocations, or significant soft tissue injury. The pelvic ring is intact and the pelvic organs are within normal limits.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No immediate radiological follow-up required. Clinical correlation per trauma protocols advised.",
        semiconcise: "No immediate radiological follow-up required. Clinical correlation per trauma protocols advised. Consider MRI if occult fracture is clinically suspected.",
        verbose: "No immediate radiological follow-up is required based on these normal CT findings. Clinical correlation per trauma protocols is advised. Consider MRI of the pelvis if there is clinical suspicion of an occult fracture, sacral insufficiency fracture, or soft tissue injury not apparent on CT.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        ...
        concise: "Normal common bile duct caliber (5mm). Normal intrahepatic biliary ducts. Normal gallbladder.",
        semiconcise: "Normal common bile duct measuring 5mm in caliber with smooth walls and no filling defects. Normal intrahepatic biliary ducts with no dilatation or strictures. Normal gallbladder with no calculi, sludge, or wall thickening. Normal cystic duct insertion.",
        verbose: "The common bile duct measures 5mm in caliber with smooth walls and no intraluminal filling defects, strictures, or periductal abnormalities. The intrahepatic biliary ducts are normal in caliber bilaterally with no evidence of dilatation, stricturing, or beading. The gallbladder is normal in size with no calculi, sludge, wall thickening, or pericholecystic fluid. The cystic duct insertion is in a normal position and the cystic duct is not dilated. The common hepatic duct and hepatic duct confluence appear normal.",
      },
      {
        label: "PANCREATIC SYSTEM",
        concise: "Normal pancreatic duct caliber (2mm). Normal pancreatic parenchyma. No focal lesions.",
        semiconcise: "Normal main pancreatic duct measuring 2mm with smooth caliber and no strictures or dilatation. Normal pancreatic parenchymal signal. No focal pancreatic lesions or cystic abnormalities. Normal pancreatic head, body, and tail.",
        verbose: "The main pancreatic duct measures 2mm in caliber with smooth contour and no focal strictures, dilatation, or filling defects throughout its course. No side branch ectasia is identified. The pancreatic parenchyma demonstrates normal signal intensity on T1 and T2 weighted sequences without evidence of focal lesions, cystic abnormalities, or pancreatic divisum. The pancreatic head, uncinate process, body, and tail are normal in size and morphology. No peripancreatic fluid collections or inflammatory changes are identified.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal MRCP. No biliary or pancreatic ductal abnormality.",
        semiconcise: "Normal MRCP examination. No biliary or pancreatic ductal abnormality. No choledocholithiasis or ductal strictures.",
        verbose: "Normal MRCP examination. No biliary or pancreatic ductal abnormality is identified. No evidence of choledocholithiasis, ductal strictures, or pancreatic pathology. The gallbladder is normal.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No radiological follow-up required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No radiological follow-up required based on these normal findings. Clinical and biochemical correlation advised if biliary symptoms persist.",
        verbose: "No radiological follow-up is required based on these normal MRCP findings. Clinical and biochemical correlation is advised if biliary symptoms persist. Consider endoscopic ultrasound if there is ongoing clinical suspicion of microlithiasis or sphincter of Oddi dysfunction.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "BILATERAL LOWER LIMB ARTERIES",
        concise: "Patent iliac, femoral, popliteal, and tibial arteries bilaterally. Normal caliber and enhancement. No stenosis, occlusion, or aneurysm.",
        semiconcise: "Patent common and external iliac arteries bilaterally with no stenosis. Patent common femoral, superficial femoral, and profunda femoris arteries bilaterally. Patent popliteal arteries with normal trifurcation. Patent anterior tibial, posterior tibial, and peroneal arteries to the ankle. Normal caliber throughout with no significant atheromatous disease, occlusion, or aneurysmal dilatation.",
        verbose: "The common and external iliac arteries are patent bilaterally with normal caliber and no significant stenosis or calcification. The common femoral arteries are patent bilaterally with normal bifurcation into the superficial femoral and profunda femoris arteries. The superficial femoral arteries are patent throughout their course bilaterally with no stenosis or occlusion. The popliteal arteries demonstrate normal caliber bilaterally with patent trifurcation. The anterior tibial, posterior tibial, and peroneal arteries are patent to the ankle bilaterally with normal enhancement. No significant atheromatous disease, haemodynamically significant stenosis, occlusion, or aneurysmal dilatation is identified at any level. The dorsalis pedis and plantar arteries are patent where visualized.",
      },
      {
        label: "SOFT TISSUES",
        concise: "Normal soft tissues and osseous structures. No masses or collections.",
        semiconcise: "Normal lower limb musculature with no masses or collections. Normal osseous structures with no suspicious lesions. No deep venous thrombosis on the arterial phase images.",
        verbose: "The lower limb musculature is normal bilaterally with no masses, collections, or abnormal enhancement. The osseous structures are unremarkable with no suspicious lytic or sclerotic lesions, pathological fractures, or erosions. No deep venous thrombosis is identified on the arterial phase images, although dedicated venous phase imaging was not performed. The subcutaneous soft tissues are unremarkable.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal lower limb arterial system bilaterally.",
        semiconcise: "Normal lower limb CTA. Patent arterial system bilaterally from aortic bifurcation to ankle with no significant stenosis or occlusion.",
        verbose: "Normal lower limb CT angiogram. Patent arterial system bilaterally from the aortic bifurcation to the pedal vessels with no haemodynamically significant stenosis, occlusion, or aneurysmal disease. No significant atheromatous burden.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No follow-up vascular imaging required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No follow-up vascular imaging required based on these normal findings. Clinical correlation advised if symptoms of peripheral vascular disease persist.",
        verbose: "No follow-up vascular imaging is required based on these normal findings. Clinical correlation is advised if symptoms of claudication or peripheral vascular disease persist. Ankle-brachial pressure index may be considered for further functional assessment if clinically indicated.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "RIGHT UPPER LIMB ARTERIES",
        concise: "Patent subclavian, axillary, brachial, radial, and ulnar arteries. Normal caliber with good distal runoff. Intact palmar arch.",
        semiconcise: "Patent right subclavian artery with normal origin and caliber. Patent axillary artery with no compression or aneurysm. Patent brachial artery throughout its course with normal bifurcation. Patent radial and ulnar arteries to the wrist with good distal runoff. Intact palmar arch where visualized.",
        verbose: "The right subclavian artery is patent with normal origin and caliber, and no evidence of stenosis or thoracic outlet compression. The axillary artery is patent with normal caliber and no aneurysmal dilatation. The brachial artery is patent throughout its course with normal bifurcation at the antecubital fossa into the radial and ulnar arteries. Both the radial and ulnar arteries are patent to the wrist with normal caliber and good distal runoff. The superficial and deep palmar arches are intact where visualized. No stenosis, occlusion, or aneurysmal dilatation at any level.",
      },
      {
        label: "SOFT TISSUES",
        concise: "Normal soft tissues and osseous structures.",
        semiconcise: "Normal right upper limb musculature with no masses or collections. Normal osseous structures. No thoracic outlet bony abnormality.",
        verbose: "The right upper limb musculature is normal with no masses, collections, or abnormal enhancement. The osseous structures of the shoulder, arm, forearm, and hand are unremarkable. No cervical rib or other thoracic outlet bony abnormality is identified. The subcutaneous soft tissues are unremarkable.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal right upper limb arterial system.",
        semiconcise: "Normal right upper limb CTA. Patent arterial system from subclavian to palmar arch with no stenosis or occlusion.",
        verbose: "Normal right upper limb CT angiogram. Patent arterial system from the subclavian artery to the palmar arches with no haemodynamically significant stenosis, occlusion, or aneurysmal dilatation.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No follow-up vascular imaging required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No follow-up vascular imaging required based on these normal findings. Clinical correlation advised. Consider duplex ultrasound if dynamic assessment is needed.",
        verbose: "No follow-up vascular imaging is required based on these normal findings. Clinical correlation is advised if symptoms persist. Consider duplex ultrasound for dynamic assessment if thoracic outlet syndrome is clinically suspected.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "AORTIC MEASUREMENTS",
        concise: "Normal aortic caliber throughout course. Coeliac axis: 1.8cm, SMA level: 1.7cm, renal level: 1.6cm, infrarenal: 1.5cm. No aneurysmal dilatation.",
        semiconcise: "Normal aortic caliber throughout its course with no aneurysmal dilatation. Centreline measurements: coeliac axis level 1.8cm, SMA level 1.7cm, renal artery level 1.6cm, infrarenal aorta 1.5cm. No mural thrombus or intimal calcification. Aortic bifurcation at L4 level.",
        verbose: "The abdominal aorta demonstrates normal caliber throughout its course with no aneurysmal dilatation or ectasia. Centreline diameter measurements are as follows: coeliac axis level 1.8cm, superior mesenteric artery level 1.7cm, renal artery level 1.6cm, and infrarenal aorta 1.5cm. No mural thrombus, significant intimal calcification, or penetrating atherosclerotic ulcer is identified. The aortic wall is smooth. The aortic bifurcation is at the L4 vertebral body level.",
      },
      {
        label: "BRANCH VESSELS",
        concise: "Patent coeliac, SMA, IMA, and renal arteries. Normal common iliac arteries (R: 0.9cm, L: 0.8cm).",
        semiconcise: "Patent coeliac axis, SMA, and IMA with normal origins and caliber. Patent bilateral renal arteries with no accessory vessels. Normal common iliac arteries (R: 0.9cm, L: 0.8cm) and external iliac arteries. No significant stenosis at any branch origin.",
        verbose: "The coeliac axis, superior mesenteric artery, and inferior mesenteric artery are patent with normal origins, caliber, and no significant stenosis. The bilateral renal arteries are patent with single arteries arising from the aorta bilaterally and no accessory renal vessels identified. The common iliac arteries are of normal caliber (right: 0.9cm, left: 0.8cm) with no aneurysmal dilatation. The external and internal iliac arteries are patent bilaterally. No significant stenosis or occlusion is identified at any branch vessel origin.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal abdominal aorta. No evidence of aneurysmal disease.",
        semiconcise: "Normal abdominal aorta and branch vessels. No aneurysmal disease. All centreline measurements within normal limits.",
        verbose: "Normal abdominal aorta and branch vessels on CT angiography. No evidence of aneurysmal disease, significant atherosclerotic stenosis, or dissection. All centreline diameter measurements are within normal limits for age and sex.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No aneurysm surveillance required. Routine cardiovascular risk management advised.",
        semiconcise: "No aneurysm surveillance imaging required based on these normal measurements. Routine cardiovascular risk factor management advised.",
        verbose: "No aneurysm surveillance imaging is required based on these normal aortic measurements. Routine cardiovascular risk factor management is advised including blood pressure control, lipid management, and smoking cessation if applicable.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "ENDOGRAFT ASSESSMENT",
        concise: "Well-positioned bifurcated aortic endograft. No migration or kinking. Patent throughout with normal contrast opacification. No endoleak.",
        semiconcise: "Well-positioned bifurcated aortic endograft with stable positioning compared to prior. No migration, kinking, or limb compression. Patent main body and bilateral limbs with normal contrast opacification. No type I, II, III, or IV endoleak on arterial or delayed phase images.",
        verbose: "The bifurcated aortic endograft is well-positioned with stable positioning compared to the prior examination. The proximal seal zone is satisfactory with no migration, tilting, or type Ia endoleak. The main body and bilateral iliac limbs are patent with normal contrast opacification and no evidence of kinking, compression, or limb occlusion. No type I, II, III, or IV endoleak is identified on the arterial or delayed phase images. No contrast extravasation into the aneurysm sac is demonstrated on any phase.",
      },
      {
        label: "ANEURYSM SAC AND VESSELS",
        concise: "Stable aneurysm sac (5.2cm). Patent renal and visceral arteries. Patent iliac arteries bilaterally.",
        semiconcise: "Stable aneurysm sac measuring 5.2cm (previously 5.2cm), with no interval enlargement. No sac enhancement to suggest endoleak. Patent renal arteries bilaterally. Patent coeliac, SMA, and IMA. Patent common and external iliac arteries bilaterally.",
        verbose: "The aneurysm sac measures 5.2cm in maximum diameter, which is stable compared to the prior examination (previously 5.2cm), with no interval enlargement. There is no sac enhancement on either the arterial or delayed phase images to suggest an occult endoleak. The bilateral renal arteries are patent with no ostial stenosis. The coeliac axis, superior mesenteric artery, and inferior mesenteric artery are patent. The common and external iliac arteries are patent bilaterally distal to the endograft limbs.",
      },
      {
        label: "CONCLUSION",
        concise: "Satisfactory EVAR appearance. No endoleak, migration, or graft occlusion.",
        semiconcise: "Satisfactory post-EVAR appearance. No endoleak on arterial or delayed phases. Stable aneurysm sac size. No migration or graft complications.",
        verbose: "Satisfactory post-EVAR appearance with no endoleak identified on arterial or delayed phase imaging. The aneurysm sac size is stable with no interval enlargement. No evidence of graft migration, limb occlusion, kinking, or structural complications. Patent branch vessels.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "Continue standard post-EVAR surveillance. Clinical follow-up for symptoms.",
        semiconcise: "Continue standard post-EVAR surveillance per vascular surgery protocol. Next surveillance CT recommended as per follow-up schedule. Clinical review if new symptoms develop.",
        verbose: "Continue standard post-EVAR surveillance per the vascular surgery team's protocol. Next surveillance CT angiogram is recommended as per the established follow-up schedule. Clinical review is advised if the patient develops new symptoms such as back pain, limb ischaemia, or signs of graft infection.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        ...
        concise: "Normal ascending aorta (3.2cm), arch (2.8cm), and descending aorta (2.1cm at diaphragm). Patent great vessels.",
        semiconcise: "Normal ascending aorta measuring 3.2cm with no root dilatation. Normal aortic arch (2.8cm) with standard branching pattern. Normal descending thoracic aorta (2.1cm at diaphragmatic hiatus). Patent brachiocephalic, left common carotid, and left subclavian arteries. No dissection flap or intramural haematoma.",
        verbose: "The ascending aorta measures 3.2cm at the level of the pulmonary artery bifurcation with no root dilatation or sinotubular junction abnormality. The aortic arch measures 2.8cm with a standard three-vessel branching pattern. The brachiocephalic, left common carotid, and left subclavian arteries are patent at their origins. The descending thoracic aorta tapers normally, measuring 2.1cm at the diaphragmatic hiatus. No dissection flap, intramural haematoma, penetrating atherosclerotic ulcer, or significant atheromatous disease is identified throughout the thoracic aorta.",
      },
      {
        label: "ABDOMINAL AORTA",
        concise: "Normal caliber: coeliac level 2.0cm, SMA level 1.9cm, renal level 1.8cm, infrarenal 1.7cm. Normal bifurcation.",
        semiconcise: "Normal abdominal aorta caliber throughout: coeliac level 2.0cm, SMA level 1.9cm, renal level 1.8cm, infrarenal 1.7cm. Normal bifurcation at L4 level. No mural thrombus or aneurysmal dilatation. Minimal aortic atheromatous calcification.",
        verbose: "The abdominal aorta is normal in caliber throughout its course with centreline measurements as follows: coeliac axis level 2.0cm, superior mesenteric artery level 1.9cm, renal artery level 1.8cm, and infrarenal aorta 1.7cm. The aortic bifurcation is at the L4 vertebral body level and is normal in configuration. No mural thrombus, aneurysmal dilatation, or significant atheromatous disease is identified. Minimal aortic wall calcification is noted, which is within normal limits for age.",
      },
      {
        label: "BRANCH VESSELS",
        concise: "Patent coeliac, SMA, IMA, and renal arteries. Normal iliac arteries.",
        semiconcise: "Patent coeliac axis with normal trifurcation. Patent SMA and IMA. Patent bilateral renal arteries with no stenosis. Normal common iliac (R: 1.0cm, L: 0.9cm) and external iliac arteries bilaterally.",
        verbose: "The coeliac axis is patent with normal trifurcation into the common hepatic, left gastric, and splenic arteries. The superior mesenteric artery and inferior mesenteric artery are patent with normal caliber and no ostial stenosis. The bilateral renal arteries are patent with no haemodynamically significant stenosis or fibromuscular dysplasia. The common iliac arteries are of normal caliber (right: 1.0cm, left: 0.9cm). The external and internal iliac arteries are patent bilaterally with no stenosis or aneurysmal change.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal thoracic and abdominal aorta. No aneurysmal or stenotic disease.",
        semiconcise: "Normal thoracoabdominal aortogram. No aneurysmal dilatation, dissection, or significant stenotic disease. All measurements within normal limits.",
        verbose: "Normal CT aortogram of the thorax, abdomen, and pelvis. No aneurysmal dilatation, dissection, intramural haematoma, or haemodynamically significant stenotic disease is identified from the aortic root to the iliac bifurcation. All aortic and branch vessel measurements are within normal limits.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No aortic surveillance required. Routine cardiovascular risk management advised.",
        semiconcise: "No aortic surveillance imaging required based on these normal measurements. Routine cardiovascular risk factor management advised.",
        verbose: "No aortic surveillance imaging is required based on these normal findings. Routine cardiovascular risk factor management is advised including blood pressure optimisation, lipid management, and smoking cessation where applicable. No further aortic imaging is indicated unless new symptoms develop.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "AORTIC ARCH AND GREAT VESSELS",
        concise: "Normal aortic arch (2.7cm). Patent brachiocephalic, left carotid, and left subclavian arteries.",
        semiconcise: "Normal aortic arch measuring 2.7cm with standard three-vessel branching pattern. Patent brachiocephalic artery with normal bifurcation. Patent left common carotid and left subclavian arteries at their origins. No arch atheroma or stenosis.",
        verbose: "The aortic arch measures 2.7cm with a standard three-vessel branching pattern and no bovine or other anatomical variant. The brachiocephalic artery is patent with normal bifurcation into the right common carotid and right subclavian arteries. The left common carotid artery is patent at its origin from the arch. The left subclavian artery is patent at its origin. No significant arch atheroma, ulcerated plaque, or ostial stenosis of the great vessels is identified.",
      },
      {
        label: "EXTRACRANIAL CAROTIDS",
        concise: "Patent bilateral carotid systems. Normal bifurcations at C4 level. Patent vertebral arteries.",
        semiconcise: "Patent bilateral common carotid arteries with normal bifurcations at C4 level. No significant carotid bulb or ICA stenosis bilaterally (NASCET <30%). Patent bilateral vertebral arteries with normal V1-V4 segments. No carotid or vertebral dissection.",
        verbose: "The bilateral common carotid arteries are patent with normal caliber. The carotid bifurcations are at the C4 vertebral body level bilaterally. There is no significant stenosis of the carotid bulbs or internal carotid arteries bilaterally, with less than 30% stenosis by NASCET criteria. The external carotid arteries are patent bilaterally. The vertebral arteries are patent bilaterally with normal V1 through V4 segments, co-dominant in caliber. No carotid or vertebral artery dissection is identified. No significant calcified or non-calcified plaque is present.",
      },
      {
        label: "INTRACRANIAL VESSELS",
        concise: "Patent intracranial carotid and vertebrobasilar systems. Complete circle of Willis. No aneurysm or stenosis.",
        semiconcise: "Patent intracranial internal carotid arteries bilaterally. Complete circle of Willis with patent anterior and posterior communicating arteries. Patent bilateral ACA, MCA, and PCA. Patent basilar artery. No aneurysm, stenosis, or AVM.",
        verbose: "The intracranial internal carotid arteries are patent bilaterally with normal caliber through the cavernous and supraclinoid segments. The circle of Willis is complete with patent anterior and posterior communicating arteries. The bilateral anterior cerebral arteries (A1 and A2 segments), middle cerebral arteries (M1 and M2 segments), and posterior cerebral arteries (P1 and P2 segments) are patent with normal caliber. The basilar artery is patent with normal caliber. No intracranial aneurysm, haemodynamically significant stenosis, or arteriovenous malformation is identified.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal aortic arch, carotid, and intracranial vessels.",
        semiconcise: "Normal CTA from aortic arch to vertex. No significant carotid stenosis, intracranial aneurysm, or large vessel occlusion.",
        verbose: "Normal CT angiogram from the aortic arch to the vertex. No significant extracranial carotid or vertebral artery stenosis. No intracranial aneurysm, large vessel occlusion, or haemodynamically significant stenosis. Complete circle of Willis.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No follow-up vascular imaging required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No follow-up vascular imaging required based on these normal findings. Clinical correlation advised if neurological symptoms persist.",
        verbose: "No follow-up vascular imaging is required based on these normal findings. Clinical correlation is advised if neurological symptoms persist. Consider carotid duplex ultrasound for ongoing surveillance if the patient has significant cardiovascular risk factors.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        ...
        concise: "Normal renal arteries arising at L1-L2. Right: 5.2mm, Left: 5.0mm diameter. No stenosis or accessory vessels.",
        semiconcise: "Single renal artery bilaterally arising from the aorta at L1-L2 level. Right renal artery: 5.2mm diameter, Left renal artery: 5.0mm diameter. No ostial or proximal stenosis. No accessory renal arteries identified. Normal early branching pattern. No fibromuscular dysplasia.",
        verbose: "A single renal artery is identified bilaterally, arising from the anterolateral aspect of the aorta at the L1-L2 vertebral body level. The right renal artery measures 5.2mm in diameter at its origin and the left renal artery measures 5.0mm. There is no ostial or proximal stenosis of either renal artery. No accessory renal arteries are identified. The early branching pattern is normal bilaterally with no evidence of fibromuscular dysplasia or beading. The renal veins are patent bilaterally.",
      },
      {
        label: "VISCERAL ARTERIES",
        concise: "Patent coeliac axis with normal trifurcation. Normal SMA (7.1mm at origin) and IMA. No stenosis.",
        semiconcise: "Patent coeliac axis with normal trifurcation into common hepatic, left gastric, and splenic arteries. No median arcuate ligament compression. Normal SMA measuring 7.1mm at origin with no stenosis. Patent IMA. No visceral artery aneurysm.",
        verbose: "The coeliac axis is patent with a normal trifurcation into the common hepatic artery, left gastric artery, and splenic artery. There is no evidence of median arcuate ligament compression or coeliac stenosis. The superior mesenteric artery measures 7.1mm at its origin and is patent throughout its course with no ostial or proximal stenosis. The inferior mesenteric artery is patent at its origin. No visceral artery aneurysm or pseudoaneurysm is identified. The replaced or accessory hepatic arterial anatomy is not identified.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal renal and visceral arteries. No stenotic or aneurysmal disease.",
        semiconcise: "Normal CTA of the renal and visceral arteries. No renal artery stenosis, fibromuscular dysplasia, or visceral artery aneurysm.",
        verbose: "Normal CT angiogram of the renal and visceral arteries. No haemodynamically significant renal artery stenosis, fibromuscular dysplasia, or visceral artery aneurysm. Standard arterial anatomy with single renal arteries bilaterally.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No follow-up vascular imaging required. Clinical correlation advised if symptoms persist.",
        semiconcise: "No follow-up vascular imaging required based on these normal findings. Clinical correlation advised if renovascular hypertension or mesenteric ischaemia remains clinically suspected.",
        verbose: "No follow-up vascular imaging is required based on these normal findings. Clinical correlation is advised if renovascular hypertension or mesenteric ischaemia remains clinically suspected. Consider duplex ultrasound for functional assessment of renal artery flow if clinical suspicion persists despite normal anatomical imaging.",
        isConclusion: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { label: "FINDINGS", text: "", isHeader: true, divider: true },
      {
        label: "BRAIN AND CERVICAL SPINE",
        concise: "Normal brain with no hemorrhage or mass effect. Intact skull. Normal cervical spine alignment with no fractures.",
        semiconcise: "Normal brain parenchyma with no intracranial hemorrhage, contusion, or mass effect. No midline shift. Intact calvarium with no fractures. Normal cervical spine alignment with intact vertebral bodies and posterior elements. No prevertebral soft tissue swelling.",
        verbose: "The brain parenchyma is normal with no intracranial hemorrhage, contusion, cerebral edema, or mass effect. There is no midline shift or uncal herniation. The ventricular system and basal cisterns are normal. The calvarium is intact with no fractures or pneumocephalus. The cervical spine demonstrates normal alignment with intact vertebral body heights, posterior elements, and facet joints. The prevertebral soft tissues are normal with no swelling to suggest ligamentous injury. The odontoid peg is intact.",
      },
      {
        label: "THORAX",
        concise: "Clear lungs with no contusion or pneumothorax. Normal mediastinum and thoracic aorta. Intact ribs and thoracic spine.",
        semiconcise: "Clear lungs bilaterally with no pulmonary contusion, pneumothorax, or hemothorax. No pericardial effusion. Normal mediastinal structures and thoracic aorta with no traumatic injury. Intact ribs bilaterally with no fractures. Normal thoracic spine alignment with no compression fractures.",
        verbose: "The lungs are clear bilaterally with no pulmonary contusion, laceration, pneumothorax, or pleural effusion. No hemothorax is identified. The heart is normal in size with no pericardial effusion. The mediastinal structures are normal with no pneumomediastinum or mediastinal hematoma. The thoracic aorta is intact with no traumatic pseudoaneurysm, dissection, or transection. The ribs are intact bilaterally with no fractures. The sternum and clavicles are intact. The thoracic spine demonstrates normal alignment with no compression fractures or posterior element injuries.",
      },
      {
        label: "ABDOMEN AND PELVIS",
        concise: "Normal abdominal organs with no laceration or hematoma. No free fluid. Normal pelvis and hip joints.",
        semiconcise: "Normal liver, spleen, kidneys, and pancreas with no laceration, hematoma, or devascularisation. Normal adrenal glands. No free intraperitoneal fluid or pneumoperitoneum. Normal bowel with no wall thickening or mesenteric injury. Intact pelvic ring with no fractures. Normal hip joints.",
        verbose: "The liver is normal with no laceration, subcapsular hematoma, or active hemorrhage. The spleen is normal in size with no laceration or perisplenic fluid. The kidneys enhance symmetrically with no laceration, hematoma, or collecting system injury. The pancreas is normal with no peripancreatic fluid. The adrenal glands are normal bilaterally with no hemorrhage. There is no free intraperitoneal fluid, retroperitoneal hemorrhage, or pneumoperitoneum. The bowel wall is normal with no thickening, mesenteric stranding, or devascularisation. The urinary bladder is intact. The pelvic ring is intact with no fractures or dislocations. The hip joints are normal bilaterally. The abdominal aorta and IVC are normal.",
      },
      {
        label: "CONCLUSION",
        concise: "Normal polytrauma study. No evidence of acute traumatic injury.",
        semiconcise: "Normal whole-body CT polytrauma study. No intracranial hemorrhage, cervical spine injury, thoracic or abdominal visceral injury, or pelvic fracture.",
        verbose: "Normal whole-body CT polytrauma study. No evidence of acute traumatic injury. Specifically, no intracranial hemorrhage, cervical spine fracture or ligamentous injury, thoracic visceral injury, pneumothorax, solid organ laceration, hollow viscus injury, vascular injury, or pelvic fracture is identified.",
        isConclusion: true,
      },
      {
        label: "RECOMMENDATIONS",
        concise: "No follow-up imaging required. Clinical observation per trauma protocols advised.",
        semiconcise: "No follow-up imaging required based on these normal findings. Clinical observation per trauma protocols advised. Consider repeat imaging if clinical deterioration occurs.",
        verbose: "No follow-up imaging is required based on these normal CT findings. Clinical observation per institutional trauma protocols is advised. Consider repeat imaging if there is clinical deterioration, new neurological signs, or evolving abdominal tenderness. MRI of the cervical spine may be considered if ligamentous injury is clinically suspected despite normal CT appearances.",
        isConclusion: true,
      },
    ],
  },
              ...
              {(() => {
                ...
                return (
                  <div key={section._key} style={{ marginBottom: section.isConclusion ? 12 : 16 }}>
                    ...
                    <textarea
                      key={isContent ? verbosity : undefined}
                      value={text}
