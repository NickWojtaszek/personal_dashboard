...
export const GripVerticalIcon = ({ className = "w-5 h-5", ...props }: React.SVGProps<SVGSVGElement>) => (
...
export const CalIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
...
export const CostIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
...
export const TilesIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const SpinnerIcon = ({ className = "w-4 h-4 animate-spin" }: { className?: string }) => (
