...
import type { InsuranceInfo, VehicleInfo, PropertyInfo, RegistrationFeeInfo } from '../../types';
...
const CATEGORY_COLORS: Record<string, string> = {
    ...
    Fee: 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400',
};
...
const CostForecastView: React.FC<CostForecastViewProps> = ({ insurancePolicies, vehicles, properties, registrationFees }) => {
    const [expandedCurrency, setExpandedCurrency] = useState<string | null>(null);

    const lineItems = useMemo(
        () => buildCostLineItems(insurancePolicies, vehicles, properties, registrationFees),
        [insurancePolicies, vehicles, properties, registrationFees],
    );
